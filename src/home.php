...
<body>
	...
	<div id="hmsLoginLinks">
		<a class="hms-nav-links" href="hostelRegistration.php">Login as Hostel</a>

		<a class="hms-nav-links" href="UserRegistration.html">Login as Student</a>

		<a class="hms-nav-links" href="adminLogin.php">Login as HH Admin</a>
	</div>
	<script>
