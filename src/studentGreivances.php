...
<body>
	...
	<script>
		...
		getUserProfile();
		function showComplaints(gUserId,gHostelId,gtitle,gdesc,gcat,gstatus,gres){
			$(".hms-userComplaints").append('<div class="hostelsOuterDiv"><div class="gtitle"><span class="g_subtitle">Student Id: </span><span class="gvalue">'+gUserId+'</span></div><div class="gtitle"><span class="g_subtitle">Hostel Id: </span><span class="gvalue">'+gHostelId+'</span></div><div class="gtitle"><span class="g_subtitle">Greivance Title: </span><span class="gvalue">'+gtitle+'</span></div><div class="gcategory"><span class="g_subtitle">Category: </span><span class="gvalue">'+gcat+'</span></div><div class="gstatus"><span class="g_subtitle">Status: </span><span class="gvalue">'+gstatus+'</span></div><div class="gdesc"><span class="g_subtitle">Description: </span><span class="gvalue">'+gdesc+'</span></div><div class="gres"><span class="g_subtitle">Resolution Provided by Hostel Team:</span><span class="gvalue">'+gres+'</span></div></div>');
		}
		function getUserComplaints(){
			...
			while ($row = mysqli_fetch_array($result)) {
			    ...
			    echo "showComplaints('$userId','$hostelId','$gtitle','$gdesc','$gcat','$gstatus','$gres');";
				}
