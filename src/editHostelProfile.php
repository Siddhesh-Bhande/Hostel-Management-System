	...
	<div id="registrationApp">
		<div class="registrationForm">
			<div class="formContainer">
				<form action="hostelChangeProfile.php" method="POST">
					<div class="form-group">
					    <label for="userFirstName">Hostel Name</label>
					    <input type="text" class="form-control" name="hostelName" id="hostelName" aria-describedby="emailHelp" placeholder="Hostel Name" required>
					</div>
					<div class="form-group">
					    <label for="userLastName">Hostel Location</label>
					    <input type="text" class="form-control" name="hostelLocation" id="hostelLocation" aria-describedby="emailHelp" placeholder="Enter Location" required>
					</div>
					<div class="form-group">
					    <label for="userAge">Contact Number</label>
					    <input type="number" class="form-control" name="hostelMobNo" id="hostelMobNo" placeholder="Mobile Number" required>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
					    ...
					    <input type="number" class="form-control" name="stdPerRoom" id="stdPerRoom" placeholder="Student Per Room" required>
					</div>
					<div class="form-group">
					    <label for="userAge">Cost per Yeah</label>
					    <input type="number" class="form-control" name="HostelCost" id="HostelCost" placeholder="Cost of housing per year" required>
					</div>
					<div class="input-group mb-3">
					  <div class="input-group-prepend">
					    <label class="input-group-text" for="inputGroupSelect01">Select Type of Hostel</label>
					  </div>
					  <select class="custom-select" id="inputGroupSelect01" name="hostelType" required>
					...
					<div class="input-group mb-3">
					  ...
					  <select class="custom-select" id="inputGroupSelect01" name="mealType" required>
					    <option selected>Choose...</option>
					...
					<div class="input-group mb-3">
					  ...
					  <select class="custom-select" id="inputGroupSelect01" name="hostelAC" required>
					    <option selected>Choose...</option>
