...
<div id='ManageBookingsApp'>
	<div class="hms-header-section">
		<div class="MainTitle"><h1><span class="hms-dorm-icon"><img src="dormitory.svg"></span>Hostels Hub<h1></div>
		<div class="HMS-nav-bar">
			...
			<a class="hms-nav-links" href="Greivance.html">Service And Maintainance</a>
		</div>
	</div>
